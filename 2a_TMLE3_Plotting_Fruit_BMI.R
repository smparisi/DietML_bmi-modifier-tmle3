########################################################################### 
#################### PLOTTING THE TMLE RESULTS - FRUIT ####################
########################################################################### 
...
# READ IN THE FRUIT TMLE OBJECT WE CREATED IN STEP #1
pree_fruit <- readRDS(file="I:/nuMoM2B/Papers/Diet ML heterogeneity 2020/Data/tmle3_fruit_pree_v4_cont_fixedcov_missind_0_new.rds")
...
muhat_0 <-  mu1*(dat$f_totdens80_0) + mu0*(1-dat$f_totdens80_0) 

# TAKE THE AIPW EFF 
X_ <- dat$f_totdens80_0
Y_ <- dat$pree_acog
...
#-------------------------------------------------------------------------------------------------------------------------------------
# PLOTTING THE BOOTSTRAPPED ESTIMATES-------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------------------
...
ggsave("I:/nuMoM2B/Diet ML heterogeneity 2020/Plots/Plots/Sara Versions/FruitPREE_BMI continuous_fixedcov_missind_0_new.png", width = 20, height = 20, dpi = 350)
#-------------------------------------------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------------------
...
#ggsave("I:/nuMoM2B/Papers/Diet ML heterogeneity 2020/Plots/Plots/Sara Versions/FruitPREE_BMI continuous_fixedcov_missind_0_new.png", width = 20, height = 20, dpi = 350)
ggsave("I:/nuMoM2B/Papers/Diet ML heterogeneity 2020/Plots/Plots/Sara Versions/FruitPREE_BMI continuous_fixedcov_missind_0_new.png", width = 5, height = 5, dpi = 350)
ggsave("I:/nuMoM2B/Papers/Diet ML heterogeneity 2020/Plots/Plots/Sara Versions/FruitPREE_BMI continuous_fixedcov_missind_0_new.pdf", width = 5, height = 5, dpi = 350)
graph2eps(file="I:/nuMoM2B/Papers/Diet ML heterogeneity 2020/Plots/Plots/Sara Versions/FruitPREE_BMI continuous_fixedcov_missind_0_new.eps", width=5, height=5, fallback_resolution=600)
